...
class MikadoInstagramWidget extends WP_Widget {
					...
					<li>
						<div class="mkd-instagram-item-holder">
							<a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
								<?php if(function_exists('hoshi_mikado_kses_img')) : ?>
								...
								<?php if($show_overlay) : ?>
									...
									<div class="mkd-instagram-overlay mkd-type1-gradient-diagonal">
	...
	public function form($instance) {
		...
		if(get_option('mkd_instagram_code')) {
			...
			<p><?php esc_html_e('You haven\'t connected with Instagram. Please go to Mikado Options -> Social page and connect with your Instagram account.', 'mikado-instagram-feed'); ?></p>
		<?php }
	}
}

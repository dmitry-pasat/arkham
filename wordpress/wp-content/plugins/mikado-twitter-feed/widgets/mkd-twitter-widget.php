...
class MikadoTwitterWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array('description' => __('Display tweets', 'mikado-instagram-feed'))
		);
	...
	private function setParams() {
		$this->params = array(
			...
			array(
				'name'  => 'user_id',
				'type'  => 'textfield',
				'title' => esc_html__('User ID','mikado-instagram-feed'),
			),
			array(
				'name'  => 'count',
				'type'  => 'textfield',
				'title' => esc_html__('Number of tweets','mikado-instagram-feed'),
			),
			array(
				'name'    => 'show_tweet_time',
				'type'    => 'dropdown',
				'title'   => esc_html__('Show tweet time','mikado-instagram-feed'),
				'options' => array(
			...
			array(
				'name'  => 'transient_time',
				'type'  => 'textfield',
				'title' => esc_html__('Tweets Cache Time','mikado-instagram-feed'),
			)
		);
	}
	...
	public function widget($args, $instance) {
		...
		if($twitter_api->hasUserConnected()) {
			...
			_e('It seams that you haven\'t connected with your Twitter account', 'hoshi');
		}

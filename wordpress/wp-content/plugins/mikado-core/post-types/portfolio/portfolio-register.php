...
class PortfolioRegister implements PostTypeInterface {
	...
	private function registerPostType() {
		global $hoshi_Framework, $hoshi_options;
		...
		if(mkd_core_theme_installed()) {
			$menuPosition = $hoshi_Framework->getSkin()->getMenuItemPosition('portfolio');
			$menuIcon     = $hoshi_Framework->getSkin()->getMenuIcon('portfolio');

			if(isset($hoshi_options['portfolio_single_slug'])) {
				if($hoshi_options['portfolio_single_slug'] != "") {
					$slug = $hoshi_options['portfolio_single_slug'];
				}
			}
		}

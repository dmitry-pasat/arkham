 ...
 * @return bool
 */
function hoshi_mikado_url_exists($url) {
...
if(!function_exists('mikado_core_init_shortcode_loader')) {
    function mikado_core_init_shortcode_loader() {

        include_once 'shortcode-loader.php';
    }

    add_action('hoshi_mikado_shortcode_loader', 'mikado_core_init_shortcode_loader');
}
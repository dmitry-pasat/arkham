<?php
if(!function_exists('hoshi_mikado_get_gradient_left_to_right_styles')) {
    function hoshi_mikado_get_gradient_left_to_right_styles($string_add = '', $empty_val = false, $custom_val = false) {
        $styles = array(
...
if(!function_exists('hoshi_mikado_get_gradient_styles')) {
    function hoshi_mikado_get_gradient_bottom_to_top_styles($string_add = '', $empty_val = false) {
        $styles = array(
...
if(!function_exists('hoshi_mikado_get_gradient_left_bottom_to_right_top_styles')) {
    function hoshi_mikado_get_gradient_left_bottom_to_right_top_styles($string_add = '', $empty_val = false) {
        $styles = array(
...
if(!function_exists('hoshi_mikado_get_gradient_diagonal_styles')) {
    function hoshi_mikado_get_gradient_diagonal_styles($string_add = '', $empty_val = false) {
        $styles = array(
            'mkd-type1-gradient-diagonal'.$string_add => 'Style 1',
            'mkd-type2-gradient-diagonal'.$string_add => 'Style 2',
        );
...
if (!function_exists('hoshi_mikado_animated_gradient_overlay')) {
    /**
     * Function that returns animated gradient overlay parameters
     **/

    function hoshi_mikado_animated_gradient_overlay($color1,$color2,$color3,$color4){
        ...
        $color1rgb = hoshi_mikado_hex2rgb($color1);
        $color2rgb = hoshi_mikado_hex2rgb($color2);
        $color3rgb = hoshi_mikado_hex2rgb($color3);
        $color4rgb = hoshi_mikado_hex2rgb($color4);

...
$excerpt_length_array = hoshi_mikado_blog_lists_number_of_chars();
...
<?php hoshi_mikado_get_title(); ?>
	<div class="mkd-container">
		<?php do_action('hoshi_mikado_action_after_container_open'); ?>
		<div class="mkd-container-inner clearfix">
			<div class="mkd-blog-holder mkd-blog-type-standard">
				...
				<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						<div class="mkd-post-content">
							<?php hoshi_mikado_get_module_template_part('templates/lists/parts/image', 'blog'); ?>
							<div class="mkd-post-text">
								<div class="mkd-post-text-inner">
									<?php hoshi_mikado_get_module_template_part('templates/lists/parts/title', 'blog'); ?>
									<div class="mkd-post-info">
										<?php
										hoshi_mikado_post_info(array(
											'date'     => 'yes',
											'author'   => 'yes',
											'category' => 'no',
											'comments' => hoshi_mikado_show_comments() ? 'yes' : 'no',
				...
				?>
				<?php do_action('hoshi_mikado_action_before_container_close'); ?>
			</div>
		</div>
		<?php do_action('hoshi_mikado_action_before_container_close'); ?>
	</div>

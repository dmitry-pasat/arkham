...
foreach($sizes as $size) {
	if(!empty($$size)) {
		$data_attr['data-'.$size] = hoshi_mikado_filter_px($$size);
	}
}

$data_attr['data-original-height'] = hoshi_mikado_filter_px($height);

?>
<div <?php echo hoshi_mikado_get_inline_attrs($data_attr); ?> class="<?php echo esc_attr(trim($css_class)); ?>" <?php print $inline_css; ?> >

<div class="mkd-page-header page-header clearfix">
    ...
    <div class="mkd-theme-name pull-left">
        <img src="<?php echo esc_url(hoshi_mikado_get_skin_uri().'/assets/img/logo.png'); ?>"
        ...
        <div class="mkd-top-section-holder-inner">
            <div class="mkd-notification-holder">
                <div class="mkd-input-change">
                    <i class="fa fa-exclamation-circle"></i><?php esc_html_e('You should save your changes', 'hoshi') ?>
                </div>
                <div class="mkd-changes-saved">
                    <i class="fa fa-check-circle"></i><?php esc_html_e('All your changes are successfully saved', 'hoshi') ?>
                </div>
            </div>
            <div class="mkd-top-buttons-holder">
                <?php if($showSaveButton) { ?>
                    <input type="button" id="mkd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'hoshi'); ?>"/>
                <?php } ?>
            </div>
        </div>
    </div>

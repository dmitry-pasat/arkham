...
class MikadoSkin extends HoshiMikadoSkinAbstract {
    /**
     * Skin constructor. Hooks to hoshi_mikado_admin_scripts_init and hoshi_mikado_enqueue_admin_styles
     */
    public function __construct() {
        $this->skinName = 'mikado';

        //hook to
        add_action('hoshi_mikado_admin_scripts_init', array($this, 'registerStyles'));
        add_action('hoshi_mikado_admin_scripts_init', array($this, 'registerScripts'));

        add_action('hoshi_mikado_enqueue_admin_styles', array($this, 'enqueueStyles'));
        add_action('hoshi_mikado_enqueue_admin_scripts', array($this, 'enqueueScripts'));

        add_action('hoshi_mikado_enqueue_meta_box_styles', array($this, 'enqueueMetaStyles'));
        add_action('hoshi_mikado_enqueue_meta_box_scripts', array($this, 'enqueueScripts'));
    ...
    public function registerScripts() {
        ...
        foreach ($this->scripts as $scriptHandle => $scriptPath) {
            hoshi_mikado_register_skin_script($scriptHandle, $scriptPath);
        }
    }
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            hoshi_mikado_register_skin_style($styleHandle, $stylePath);
        }
    ...
    public function renderOptions() {
        ...
        $tab    		= hoshi_mikado_get_admin_tab();
        $active_page 	= $hoshi_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
*@param HoshiMikadoAdminPage $page current page to load
...
*@param HoshiMikadoAdminPage $page current page to load
    ...
    public function renderImport() { ?>
        <div class="mkd-options-page mkd-page">
            <?php $this->getHeader(hoshi_mikado_get_theme_info_item('Name'), hoshi_mikado_get_theme_info_item('Version'), false); ?>
            <div class="mkd-page-content-wrapper">
                <div class="mkd-page-content">
                    <div class="mkd-page-navigation mkd-tabs-wrapper vertical left clearfix">

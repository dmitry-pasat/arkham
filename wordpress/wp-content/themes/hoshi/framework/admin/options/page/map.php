...
if(!function_exists('hoshi_mikado_page_options_map')) {

    function hoshi_mikado_page_options_map() {

        hoshi_mikado_add_admin_page(
            array(
                'slug'  => '_page_page',
                'title' => esc_html__('Page', 'hoshi'),
        ...
        $panel_sidebar = hoshi_mikado_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => esc_html__('Design Style', 'hoshi')
            )
        );
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'description'   => esc_html__('Choose a sidebar layout for pages', 'hoshi'),
        ...
        if(count($custom_sidebars) > 0) {
            hoshi_mikado_add_admin_field(array(
                ...
                'description' => esc_html__('Choose a sidebar to display on pages. Default sidebar is "Sidebar"', 'hoshi'),
                'parent'      => $panel_sidebar,
    ...
    add_action('hoshi_mikado_options_map', 'hoshi_mikado_page_options_map', 9);

...
add_action('after_setup_theme', 'hoshi_mikado_admin_map_init', 0);

function hoshi_mikado_admin_map_init() {

	do_action('hoshi_mikado_before_options_map');
	...
	do_action('hoshi_mikado_options_map');

	do_action('hoshi_mikado_after_options_map');

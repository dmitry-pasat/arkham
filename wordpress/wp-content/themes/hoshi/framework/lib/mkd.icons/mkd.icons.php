...
/*
  Class: HoshiMikadoIconCollections
...
class HoshiMikadoIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new HoshiMikadoIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new HoshiMikadoIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new HoshiMikadoIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new HoshiMikadoLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('linear_icons', new HoshiMikadoLinearIcons('Linear Icons', 'linear_icon'));
        $this->addIconCollection('simple_line_icons', new HoshiMikadoSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new HoshiMikadoDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getSocialVCParamsArray($iconPackDependency = array(), $iconCollectionPrefix = "", $emptyIconPack = false, $exclude = '') {
        ...
        $iconPackParams = array(
            'type'        => 'dropdown',
            'heading'     => esc_html__('Icon pack', 'hoshi'),
    ...
    public function getWidgetIconParams() {
        ...
        $iconPackParams[] = array(
            'type'    => 'dropdown',
            'title'   => esc_html__('Icon Pack', 'hoshi'),
            'name'    => 'icon_pack',
            'options' => array(
                'font_awesome'      => esc_html__('Font Awesome', 'hoshi'),
                'font_elegant'      => esc_html__('Font Elegant', 'hoshi'),
                'ion_icons'         => esc_html__('Ion Icons', 'hoshi'),
                'simple_line_icons' => esc_html__('Simple Line Icons', 'hoshi')
            )
        );
    ...
    public function getIconCollectionIcons(iHoshiMikadoIconCollection $collection) {
...
$hoshi_IconCollections = HoshiMikadoIconCollections::get_instance();
...
class HeaderDivided extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = hoshi_mikado_filter_px(hoshi_mikado_options()->getOptionValue('menu_area_height_header_divided'));
            $this->menuAreaHeight = $menuAreaHeight !== '' ? intval($menuAreaHeight) : 86;
    ...
    public function headerPerPageStyles($style) {
        ...
        $disable_border = hoshi_mikado_get_meta_field_intersect('menu_area_border_header_divided',$id) == 'no';
        $disable_grid_border = hoshi_mikado_get_meta_field_intersect('menu_area_in_grid_border_header_divided',$id) == 'no';
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters['menu_area_in_grid'] = hoshi_mikado_get_meta_field_intersect('menu_area_in_grid_header_divided',$id) == 'yes' ? true : false;

        $parameters = apply_filters('hoshi_mikado_header_divided_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (hoshi_mikado_options()->getOptionValue('menu_area_background_transparency_header_divided') !== '1' && hoshi_mikado_options()->getOptionValue('menu_area_background_transparency_header_divided') !== '') {
            $menuAreaTransparent = true;
        } else if (is_404() && hoshi_mikado_options()->getOptionValue('404_menu_area_background_transparency_header') !== '1' && hoshi_mikado_options()->getOptionValue('404_menu_area_background_transparency_header') !== '') {
            $menuAreaTransparent = true;
        } else {
        ...
        if($menuAreaTransparent) {
            ...
            if(hoshi_mikado_is_top_bar_enabled() || hoshi_mikado_is_top_bar_enabled() && hoshi_mikado_is_top_bar_transparent()) {
    ...
    public function calculateHeightOfCompleteTransparency() {
        ...
        $menuAreaTransparent = hoshi_mikado_options()->getOptionValue('fixed_header_transparency') === '0';
    ...
    public function getPerPageJSVariables($perPageVars) {
        ...
        if(!in_array(hoshi_mikado_options()->getOptionValue('header_behaviour'), array('sticky-header-on-scroll-up','sticky-header-on-scroll-down-up'))) {

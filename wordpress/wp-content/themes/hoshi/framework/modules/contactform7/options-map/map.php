...
if(!function_exists('hoshi_mikado_contact_form_7_options_map')) {

    function hoshi_mikado_contact_form_7_options_map() {

        hoshi_mikado_add_admin_page(array(
            'slug'  => '_contact_form7_page',
            'title' => esc_html__('Contact Form 7', 'hoshi'),
            'icon'  => 'icon_mail_alt'
        ));

        $panel_contact_form_style_1 = hoshi_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_1',
            'title' => esc_html__('Custom Style 1', 'hoshi')
        ));

        //Text Typography

        $typography_text_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'typography_text_group',
            'title'       => esc_html__('Form Text Typography', 'hoshi'),
            'description' => esc_html__('Setup typography for form elements text', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $typography_text_row1 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Text Color', 'hoshi'),
        ));
        ...
        $typography_text_row2 = hoshi_mikado_add_admin_row(array(
        ...
        $typography_text_row3 = hoshi_mikado_add_admin_row(array(
        ...
        $typography_label_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'typography_label_group',
            'title'       => esc_html__('Form Label Typography', 'hoshi'),
            'description' => esc_html__('Setup typography for form elements label', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $typography_label_row1 = hoshi_mikado_add_admin_row(array(
        ...
        $typography_label_row2 = hoshi_mikado_add_admin_row(array(
        ...
        $background_border_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'background_border_group',
            'title'       => esc_html__('Form Elements Background and Border', 'hoshi'),
            'description' => esc_html__('Setup form elements background and border style', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $background_border_row1 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Background Color', 'hoshi')
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Background Transparency', 'hoshi')
        ));

        $background_border_row2 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Transparency', 'hoshi'),
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Border Color', 'hoshi')
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Focus Border Transparency', 'hoshi')
        ));

        $background_border_row3 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Width', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Radius', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        $padding_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'padding_group',
            'title'       => 'Elements Padding',
            'description' => esc_html__('Setup form elements padding', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $padding_row = hoshi_mikado_add_admin_row(array(
            'name'   => 'padding_row',
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Padding Top', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Padding Bottom', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        $margin_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'margin_group',
            'title'       => esc_html__('Elements Margin', 'hoshi'),
            'description' => esc_html__('Setup form elements margin', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $margin_row = hoshi_mikado_add_admin_row(array(
            'name'   => 'margin_row',
            'parent' => $margin_group
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Margin Top', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Margin Bottom', 'hoshi'),
            'args'          => array(
                'suffix' => 'px'
            )
        ));
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Textarea Height', 'hoshi'),
            'description'   => esc_html__('Enter height for textarea form element', 'hoshi'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        $button_typography_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'button_typography_group',
            'title'       => 'Button Typography',
            'description' => esc_html__('Setup button text typography', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $button_typography_row1 = hoshi_mikado_add_admin_row(array(
        ...
        $button_typography_row2 = hoshi_mikado_add_admin_row(array(
        ...
        $button_background_border_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'button_background_border_group',
            'title'       => esc_html__('Button Background and Border', 'hoshi'),
            'description' => esc_html__('Setup button background and border style', 'hoshi'),
            'parent'      => $panel_contact_form_style_1
        ));

        $button_background_border_row1 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Background Hover Transparency', 'hoshi')
        ));

        $button_background_border_row2 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Border Hover Transparency', 'hoshi')
        ));

        $button_background_border_row3 = hoshi_mikado_add_admin_row(array(
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Button Height', 'hoshi'),
            'description'   => esc_html__('Insert form button height', 'hoshi'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => '',
            'label'         => esc_html__('Button Left/Right Padding', 'hoshi'),
            'description'   => esc_html__('Enter value for button left and right padding', 'hoshi'),
            'args'          => array(
                'col_width' => '3',
                'suffix'    => 'px'
            )
        ...
        hoshi_mikado_add_admin_field(array(
            ...
            'default_value' => 'no',
            'label'         => esc_html__('Show Full Width Button', 'hoshi'),
            'description'   => esc_html__('Set this option to "Yes" if you would like the Content Form button to be full width', 'hoshi'),
        ));

        $panel_contact_form_style_2 = hoshi_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
            'name'  => 'panel_contact_form_style_2',
            'title' => esc_html__('Custom Style 2', 'hoshi')
        ));
        ...
        $padding_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'padding_group',
            'title'       => esc_html__('Elements Padding', 'hoshi'),
            'description' => esc_html__('Setup form elements padding', 'hoshi'),
            'parent'      => $panel_contact_form_style_2
        ));
        ...
        $button_typography_group = hoshi_mikado_add_admin_group(array(
            'name'        => 'button_typography_group',
            'title'       => esc_html__('Button Typography', 'hoshi'),
            'description' => esc_html__('Setup button text typography', 'hoshi'),
            'parent'      => $panel_contact_form_style_2
        ));
        ...
        $panel_contact_form_style_3 = hoshi_mikado_add_admin_panel(array(
            'page'  => '_contact_form7_page',
    ...
    add_action('hoshi_mikado_options_map', 'hoshi_mikado_contact_form_7_options_map', 18);

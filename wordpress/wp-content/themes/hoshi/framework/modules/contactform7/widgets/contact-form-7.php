...
class HoshiMikadoContactForm7 extends HoshiMikadoWidget {
    protected $params;

    public function __construct() {
        parent::__construct(
            'mkd_contact_form7_widget', // Base ID
            esc_html__('Mikado Contact Form 7','hoshi'), // Name
            array('description' => esc_html__('Display Contact Form 7', 'hoshi'),) // Args
        );
    ...
    protected function setParams() {
        ...
        if($cf7) {
            ...
            $contact_forms[__('No contact forms found', 'hoshi')] = 0;
        }
...
//
        ...
        echo '<div class="widget mkd-contact-form-7-widget'.$layout_type.$layout_color.$cf_custom_style.'" '.hoshi_mikado_get_inline_style($cfStyles).'>';
        ...
        echo hoshi_mikado_execute_shortcode('contact-form-7', $params);
...
add_action('widgets_init', function () {
    register_widget('HoshiMikadoContactForm7');
});

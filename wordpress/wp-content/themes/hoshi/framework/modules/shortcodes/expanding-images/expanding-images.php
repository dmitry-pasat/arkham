...
namespace Hoshi\Modules\Shortcodes\ExpandingImages;
...
class ExpandingImages implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Expanding Images', 'hoshi'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                ...
                array(
                    'type'        => 'textfield',
                    'heading'     => esc_html__('Holder Width (%)', 'hoshi'),
                    'param_name'  => 'width',
                    'description' => esc_html__('Set width of holder relative to container (this is optional, in order to improve responsiveness)', 'hoshi')
                )
            )
        ));
    }
    ...
    public function render($atts, $content = null) {
        ...
        return hoshi_mikado_get_shortcode_module_template_part('templates/expanding-images', 'expanding-images', '', $params);
    }
    ...
    private function getGalleryImages($params) {
        ...
        foreach($image_ids as $id) {
            ...
            $image_dimensions = hoshi_mikado_get_image_dimensions($image['url']);

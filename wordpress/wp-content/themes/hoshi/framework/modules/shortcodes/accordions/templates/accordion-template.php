<h4 class="clearfix mkd-title-holder <?php echo esc_attr($dark_type) ?>">
...
<span class="mkd-tab-title">
		<span class="mkd-tab-title-inner">
			...
			<?php if($params['number']) : ?>
				<span class="mkd-accordion-number" <?php hoshi_mikado_inline_style($color_number)?>><?php echo esc_attr($number) ?></span>
			<?php endif; ?>

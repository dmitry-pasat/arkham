<?php
namespace Hoshi\Modules\Accordion;
...
class Accordion implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                    => esc_html__('Accordion', 'hoshi'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    ...
                    'param_name'  => 'style',
                    'value'       => array(
                        esc_html__('Accordion', 'hoshi')       => 'accordion',
                        esc_html__('Boxed Accordion', 'hoshi') => 'boxed_accordion',
                        esc_html__('Toggle', 'hoshi')          => 'toggle',
                        esc_html__('Boxed Toggle', 'hoshi')    => 'boxed_toggle'
                    ),
                    'save_always' => true,
                    'description' => ''
                )
    ...
    public function render($atts, $content = null) {
        ...
        $output .= hoshi_mikado_get_shortcode_module_template_part('templates/accordion-holder-template', 'accordions', '', $params);

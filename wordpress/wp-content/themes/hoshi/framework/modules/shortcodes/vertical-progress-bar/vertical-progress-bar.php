...
namespace Hoshi\Modules\Shortcodes\VerticalProgressBar;
...
class VerticalProgressBar implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Vertical Progress Bar', 'hoshi'),
            'base'                      => $this->base,
            ...
            'params'                    => array(
                ...
                array(
                    'type'        => 'colorpicker',
                    'admin_label' => true,
                    'heading'     => esc_html__('Bar Color', 'hoshi'),
    ...
    public function render($atts, $content = null) {
        ...
        return hoshi_mikado_get_shortcode_module_template_part('templates/vertical-progress-bar', 'vertical-progress-bar', '', $params);
    }

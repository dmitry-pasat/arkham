<?php
namespace Hoshi\Modules\Shortcodes\VerticalSplitSliderContentItem;
...
class VerticalSplitSliderContentItem implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'      => esc_html__('Slide Content Item', 'hoshi'),
            'base'      => $this->base,
            ...
            'params'    => array(
                ...
                array(
                    ...
                    'value'       => '',
                    'description' => esc_html__('Please insert padding in format "10px 0 10px 0"', 'hoshi')
                ),
                array(
                    'type'       => 'dropdown',
                ...
                array(
                    'type'       => 'dropdown',
                    'heading'    => esc_html__('Header/Bullets Style', 'hoshi'),
    ...
    public function render($atts, $content = null) {
        ...
        $html = hoshi_mikado_get_shortcode_module_template_part('templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params);

<?php
namespace Hoshi\Modules\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Pie Chart', 'hoshi'),
            'base'                      => $this->getBase(),
            ...
            'params'                    => array(
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Type of Central text', 'hoshi'),
                    'param_name'  => 'type_of_central_text',
                    'value'       => array(
                        esc_html__('Percent', 'hoshi') => 'percent',
                ...
                array(
                    'type'        => 'textfield',
                    'heading'     => esc_html__('Size(px)', 'hoshi'),
                    'param_name'  => 'size',
                    'description' => '',
                    'admin_label' => true,
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Active Color', 'hoshi'),
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Inactive Color', 'hoshi'),
                ...
                array(
                    'type'        => 'textfield',
                    'heading'     => esc_html__('Margin below chart (px)', 'hoshi'),
                ...
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Typography Style', 'hoshi'),
    ...
    public function render($atts, $content = null) {
        ...
        $params['active_color'] = $params['active_color'] !== '' ? $params['active_color'] : hoshi_mikado_get_first_main_color();
        ...
        $html = hoshi_mikado_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);

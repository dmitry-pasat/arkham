<?php
namespace Hoshi\Modules\CustomFont;
...
class CustomFont implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                      => esc_html__('Custom Font', 'hoshi'),
            'base'                      => $this->getBase(),
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                array(
                    "type"       => "dropdown",
                    "heading"    => esc_html__("Custom Font Tag", 'hoshi'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Font family", 'hoshi'),
                ...
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Line height (px)", 'hoshi'),
                    "param_name" => "line_height",
                    "value"      => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Font Style", 'hoshi'),
                    "param_name"  => "font_style",
                    "value"       => hoshi_mikado_get_font_style_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    ...
                    "value"       => array_flip(hoshi_mikado_get_font_weight_array()),
                    "save_always" => true
                ),
                array(
                    "type"       => "textfield",
                    "heading"    => esc_html__("Letter Spacing (px)", 'hoshi'),
                ...
                array(
                    ...
                    "value"       => hoshi_mikado_get_text_transform_array(),
                    "description" => ""
                ),
                array(
                    "type"        => "dropdown",
                    "heading"     => esc_html__("Text decoration", 'hoshi'),
                    "param_name"  => "text_decoration",
                    "value"       => array(
                        esc_html__('None', 'hoshi')         => '',
                        esc_html__('Underline', 'hoshi')    => 'underline',
                        esc_html__('Overline', 'hoshi')     => 'overline',
                        esc_html__('Line Through', 'hoshi') => 'line-through'
                    ),
                    "description" => ""
                ),
                array(
                ...
                array(
                    ...
                    "value"       => array(
                        ...
                        esc_html__('Justify', 'hoshi') => 'justify'
                    ),
                    "description" => ""
                ),
                array(
                    ...
                    "value"       => esc_html__('Custom Font Content', 'hoshi'),
                    "description" => "",
                    "save_always" => true
                )
            )
    ...
    public function render($atts, $content = null) {
        ...
        $html = hoshi_mikado_get_shortcode_module_template_part('templates/custom-font-template', 'customfont', '', $params);

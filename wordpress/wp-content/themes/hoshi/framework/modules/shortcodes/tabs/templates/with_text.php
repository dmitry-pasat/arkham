<div class="mkd-tabs <?php echo esc_attr($tab_class) ?> clearfix">
	<ul class="mkd-tabs-nav">
		<?php foreach($tabs_titles_subtitles as $tab_title_subtitle) { ?>
			<li>
				<a href="#tab-<?php echo sanitize_title($tab_title_subtitle['tab_title']) ?>" class="<?php echo esc_attr($active_tab_style); ?>">
		...
		<?php } ?>
		<li class="mkd-tab-line"><span class="mkd-tab-line-inner <?php echo esc_attr($gradient_style); ?>"></span></li>
	</ul>

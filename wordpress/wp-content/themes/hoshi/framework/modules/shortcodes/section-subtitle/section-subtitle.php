<?php
namespace Hoshi\Modules\Shortcodes\SectionSubtitle;
...
class SectionSubtitle implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Section Subtitle', 'hoshi'),
            'base'                      => $this->base,
            'category'                  => 'by MIKADO',
            ...
            'params'                    => array(
                array(
                    ...
                    'save_always' => true,
                    'admin_label' => true,
                    'description' => esc_html__('Choose color of your subtitle', 'hoshi')
                ),
                array(
                    'type'        => 'dropdown',
                ...
                array(
                    ...
                    'param_name'  => 'width',
                    'description' => esc_html__('Adjust the width of section subtitle in percentages. Ommit the unit', 'hoshi'),
                    'value'       => '',
                    'save_always' => true,
                    'admin_label' => true
                )
    ...
    public function render($atts, $content = null) {
        ...
        if($params['text'] !== '') {
            ...
            return hoshi_mikado_get_shortcode_module_template_part('templates/section-subtitle-template', 'section-subtitle', '', $params);
        }
    }

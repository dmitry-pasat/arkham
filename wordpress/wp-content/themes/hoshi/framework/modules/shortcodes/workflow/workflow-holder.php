<?php
namespace Hoshi\Modules\Workflow;
...
class Workflow implements ShortcodeInterface {
    ...
    public function vcMap() {
        ...
        vc_map(array(
            'name'                    => esc_html__('Workflow', 'hoshi'),
            'base'                    => $this->base,
            ...
            'params'                  => array(
                ...
                array(
                    'type'        => 'colorpicker',
                    'heading'     => esc_html__('Workflow line color', 'hoshi'),
                    'param_name'  => 'line_color',
                    'description' => esc_html__('Pick a color for the workflow line.', 'hoshi')
                ),
                array(
                    'type'        => 'dropdown',
                    'heading'     => esc_html__('Animate Workflow', 'hoshi'),
                    'param_name'  => 'animate',
                    'value'       => array(
                        esc_html__('Yes', 'hoshi') => 'yes',
                        esc_html__('No', 'hoshi')  => 'no',
                    ),
                    'description' => esc_html__('Animate Workflow shortcode when it comes into viewport', 'hoshi'),
                    'save_always' => true,
                )
            )
        ));
    ...
    public function render($atts, $content = null) {
        ...
        $output .= hoshi_mikado_get_shortcode_module_template_part('templates/workflow-holder-template', 'workflow', '', $params);

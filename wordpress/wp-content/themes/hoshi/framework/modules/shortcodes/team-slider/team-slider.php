...
class TeamSlider implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'         => esc_html__('Team Slider', 'hoshi'),
            'base'         => $this->base,
            'category'     => 'by MIKADO',
            ...
            'params'       => array(
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Number of Items in Row', 'hoshi'),
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Enable AutoPlay?', 'hoshi'),
                ...
                array(
                    'type'        => 'dropdown',
                    'admin_label' => true,
                    'heading'     => esc_html__('Enable Pagination?', 'hoshi'),
    ...
    public function render($atts, $content = null) {
        ...
        return hoshi_mikado_get_shortcode_module_template_part('templates/team-slider-template', 'team-slider', '', $params);
    }

...
<div class="mkd-team-item-wrapper">
    <div class="mkd-team <?php echo esc_attr($team_type) ?><?php echo esc_attr($box_class) ?><?php echo esc_attr($flip_class) ?>" <?php if($flip_on_hover != 'yes') { hoshi_mikado_inline_style($team_shadow_styles); } ?> >
        <?php if($flip_on_hover == 'yes') { ?>
            <div class="mkd-team-front" <?php hoshi_mikado_inline_style($team_shadow_styles); ?> >
        <?php } ?>
                    ...
                    <?php if($team_name !== '' || $team_position !== '') { ?>
                        <div class="mkd-team-title-holder <?php echo esc_attr($team_social_icon_type) ?>">
                            ...
                            <?php if($team_position !== "") { ?>
                                <h6 class="mkd-team-position <?php echo esc_attr($light_class); ?>" <?php hoshi_mikado_inline_style($background_styles); ?>><?php echo esc_attr($team_position) ?></h6>
                            <?php } ?>
                        </div>
                    <?php } ?>

<?php
namespace Hoshi\Modules\Message;
...
class Message implements ShortcodeInterface {
				...
				array(
					array(
						...
						'value'       => array(
							...
							esc_html__('With Icon', 'hoshi') => 'with_icon'
						),
						'save_always' => true
					)
				),
				\HoshiMikadoIconCollections::get_instance()->getVCParamsArray(array(
					'element' => 'type',
					'value'   => 'with_icon'
				)),
				array(
					...
					array(
						'type'        => 'textfield',
						'heading'     => esc_html__('Border Width (px)', 'hoshi'),
						'param_name'  => 'border_width',
						'description' => esc_html__('Default value is 0', 'hoshi')
					),
					array(
						'type'        => 'colorpicker',
						'heading'     => esc_html__('Close Icon Color', 'hoshi'),
	...
	public function render($atts, $content = null) {
		...
		$html = hoshi_mikado_get_shortcode_module_template_part('templates/message-holder-template', 'message', '', $params);

 ...
 */
class HoshiMikadoSocialIconWidget extends HoshiMikadoWidget {
    /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            esc_html__('Mikado Social Icon Widget', 'hoshi') // Name
        );
    ...
    protected function setParams() {
        $this->params = array_merge(
            hoshi_mikado_icon_collections()->getSocialIconWidgetParamsArray(),
            array(
                array(
                    'type'        => 'textfield',
                ...
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Text Size (px)', 'hoshi'),
                    'name'        => 'text_size',
                    'description' => ''
                ),
                array(
                ...
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Hover Color', 'hoshi'),
                    'name'        => 'hover_color',
                    'description' => ''
                ),
                array(
                    'type'        => 'textfield',
                    'title'       => esc_html__('Margin', 'hoshi'),
                    'name'        => 'margin',
    ...
    public function widget($args, $instance) {
        ...
        <a class="mkd-social-icon-widget-holder" <?php echo hoshi_mikado_get_inline_attr($hover_color, 'data-hover-color'); ?> <?php hoshi_mikado_inline_style($social_icon_styles) ?> href="<?php echo esc_html($link); ?>" target="<?php echo esc_attr($target); ?>">

...
if(!function_exists('hoshi_mikado_title_classes')) {
	/**
	 ...
	 */
	function hoshi_mikado_title_classes($classes = array()) {
		$classes = array();
		$classes = apply_filters('hoshi_mikado_title_classes', $classes);
...
if(!function_exists('hoshi_mikado_title_type_class')) {
	/**
	 ...
	 */
	function hoshi_mikado_title_type_class($classes) {
		$id = hoshi_mikado_get_page_id();

		if(($meta_temp = get_post_meta($id, "mkd_title_area_type_meta", true)) !== "") {
			$title_type = $meta_temp;
		} else {
			$title_type = hoshi_mikado_options()->getOptionValue('title_area_type');
		}
	...
	add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_type_class');
}

if(!function_exists('hoshi_mikado_title_background_image_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function hoshi_mikado_title_background_image_classes($classes) {
		//init variables
		$id                      = hoshi_mikado_get_page_id();
		$is_img_responsive       = '';
		$is_image_parallax       = '';
		...
		if(($meta_temp = get_post_meta($id, "mkd_title_area_background_image_meta", true)) != "") {
			...
			$title_img = hoshi_mikado_options()->getOptionValue('title_area_background_image');
		}
		...
		if(($meta_temp = get_post_meta($id, "mkd_title_area_background_image_parallax_meta", true)) != "") {
			...
			$is_image_parallax = hoshi_mikado_options()->getOptionValue('title_area_background_image_parallax');
		}
	...
	add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_background_image_classes');
}

if(!function_exists('hoshi_mikado_title_content_alignment_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function hoshi_mikado_title_content_alignment_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkd_title_area_content_alignment_meta", true)) != "") {
			...
			$title_content_alignment = hoshi_mikado_options()->getOptionValue('title_area_content_alignment');
		}
	...
	add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_content_alignment_class');
}


if(!function_exists('hoshi_mikado_title_text_size_class')) {
    /**
     ...
     * @return array changed array of classes
     */
    function hoshi_mikado_title_text_size_class($classes) {

        //init variables

        if(hoshi_mikado_is_woocommerce_installed() && hoshi_mikado_is_woocommerce_shop() && is_shop()) {
            $id = hoshi_mikado_get_woo_shop_page_id();
        } else {
            $id = get_the_ID();
        }

        $title_size = hoshi_mikado_get_meta_field_intersect('title_area_text_size', $id);
        $classes[] = 'mkd-title-'.$title_size.'-text-size';

        return $classes;

    }

    add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_text_size_class');
}

if(!function_exists('hoshi_mikado_title_animation_class')) {
	/**
	 ...
	 * @return array changed array of classes
	 */
	function hoshi_mikado_title_animation_class($classes) {
		...
		if(($meta_temp = get_post_meta($id, "mkd_title_area_animation_meta", true)) !== "") {
			...
			$title_animation = hoshi_mikado_options()->getOptionValue('title_area_animation');
		}
	...
	add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_animation_class');
}

if(!function_exists('hoshi_mikado_title_background_image_div_classes')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function hoshi_mikado_title_background_image_div_classes($classes) {
	...
	add_filter('hoshi_mikado_title_classes', 'hoshi_mikado_title_background_image_div_classes');
}

if(!function_exists('hoshi_mikado_has_subtitle_body_class')) {
	/**
	 * @param $classes
	 *
	 * @return array
	 */
	function hoshi_mikado_has_subtitle_body_class($classes) {
		$id                    = hoshi_mikado_get_page_id();
	...
	add_action('body_class', 'hoshi_mikado_has_subtitle_body_class');
}
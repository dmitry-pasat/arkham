<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
	<div class="mkd-masonry-gallery-quote-holder <?php echo esc_attr(hoshi_mikado_options()->getOptionValue('blog_gradient_element_style')); ?>">
		...
		<div class="mkd-masonry-gallery-quote-holder-bgrnd <?php echo esc_attr(hoshi_mikado_options()->getOptionValue('blog_gradient_element_style')); ?>"></div>
	</div>
</article>
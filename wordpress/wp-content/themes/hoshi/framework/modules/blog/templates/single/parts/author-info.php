<?php
$author_info_box   = esc_attr(hoshi_mikado_options()->getOptionValue('blog_author_info'));
$author_info_email = esc_attr(hoshi_mikado_options()->getOptionValue('blog_author_info_email'));
$social_networks   = hoshi_mikado_get_user_custom_fields();
    ...
    <div class="mkd-author-description">
        <div class="mkd-author-description-inner clearfix">
            <div class="mkd-author-description-image">
                <?php echo hoshi_mikado_kses_img(get_avatar(get_the_author_meta('ID'), 300)); ?>
            </div>
                    ...
                    <div class="mkd-author-social-holder">
                        <?php foreach($social_networks as $network) { ?>
                            <a href="<?php echo esc_attr($network['link']) ?>" target="blank">
                                <?php echo hoshi_mikado_icon_collections()->renderIcon($network['class'], 'font_awesome'); ?>
                            </a>
                        <?php } ?>
                    </div>

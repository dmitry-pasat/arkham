...
hoshi_mikado_get_title();
get_template_part('slider');

$full_width = false;

if(hoshi_mikado_options()->getOptionValue('mkd_woo_products_list_full_width') == 'yes' && !is_singular('product')) {
	$full_width = true;
}

if($full_width) { ?>
<div class="mkd-full-width" <?php hoshi_mikado_inline_style($background_color); ?>>
	<?php } else { ?>
	<div class="mkd-container" <?php hoshi_mikado_inline_style($background_color); ?>>
		<?php }
		if($full_width) { ?>
		<div class="mkd-full-width-inner" <?php hoshi_mikado_inline_style($content_style); ?>>
			<?php } else { ?>
			<div class="mkd-container-inner clearfix" <?php hoshi_mikado_inline_style($content_style); ?>>
				<?php }
				...
				if(!is_singular('product')) {
					...
					switch($sidebar) {
							...
							<div class="mkd-two-columns-66-33 grid2 mkd-woocommerce-with-sidebar clearfix">
								<div class="mkd-column1">
									<div class="mkd-column-inner">
										<?php hoshi_mikado_woocommerce_content(); ?>
									</div>
								</div>
						...
						case 'sidebar-25-left': ?>
							...
							break;
						default:
							hoshi_mikado_woocommerce_content();
					}
